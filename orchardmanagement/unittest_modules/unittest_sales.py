...
class TestSalesManagement(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remaining_productivity_origin_df = pd.read_csv(
            os.path.join(curr_dict, "management_testing_files/remaining_productivity_origin.csv"))
        cls.extra_productivity_origin_df = pd.read_csv(
            os.path.join(curr_dict, "management_testing_files/extra_productivity_origin.csv"))
        cls.orders_origin_df = pd.read_csv(
            os.path.join(curr_dict, "management_testing_files/orders_origin.csv"))
